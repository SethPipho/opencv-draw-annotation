...
def draw_bounding_box(image, 
    ...
    for i,label in enumerate(labels):
        ...
        cv2.rectangle(image, (label_xmin, label_ymin), (label_xmax, label_ymax), color, -1)
        cv2.putText(image, label,(label_xmin + text_padding, label_ymin + text_height + text_padding), font_face, font_size,(255,255,255), font_weight, cv2.LINE_AA)
